...
int main() {
  ...
  //gROOT->ProcessLine(".x lhcbStyle.C");
	...
	TH1F *omega_invmass = new TH1F("omega_invmass","Reconstructed omega invariant mass from electron pairs", 100, 0.0, 0.1);
    	omega_invmass -> GetXaxis()-> SetTitle("mass (GeV)");
...
std::cout<<"Total number of entries: "<<nentries<<std::endl;
	...
	c1->Modified();
	c1->Update();
	c1->Print("project4_omegainvmass1.pdf","pdf");
